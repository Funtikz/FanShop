package org.example.fanshop.service.api;
...
public interface UserImageService {
     ...
     * @throws org.example.fanshop.exceptions.FileIsEmpty Если переданный файл пустой.
     * @throws org.springframework.web.server.ResponseStatusException Если возникла ошибка при обновлении изображения.
     */
    void changeProfileImage(ImageUploadDto imageUploadDto) throws org.example.fanshop.exceptions.FileIsEmpty, org.springframework.web.server.ResponseStatusException;
     ...
     * @throws org.example.fanshop.exceptions.UserImageProfileNotFound Если у пользователя нет изображения для удаления.
     */
    void deleteProfileImageAndUploadDefault(Long userId) throws org.example.fanshop.exceptions.UserImageProfileNotFound;
     ...
     * @return Объект {@link org.example.fanshop.entity.UserImage}, представляющий изображение профиля пользователя.
