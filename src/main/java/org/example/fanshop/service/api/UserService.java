...
public interface UserService {
     ...
     * @throws org.example.fanshop.exceptions.UserAlreadyExistsException Если пользователь с таким номером уже существует.
     * @throws org.example.fanshop.exceptions.DifferentPassword Если введенные пароли не совпадают.
     * @throws org.example.fanshop.exceptions.MappingException Если произошла ошибка при преобразовании DTO в сущность.
     */
     ...
     * @throws org.example.fanshop.exceptions.UsernameNotFoundException Если пользователь с таким номером не найден.
     */
     ...
     * @throws org.example.fanshop.exceptions.AuthenticationException Если пользователь не авторизован.
     */
